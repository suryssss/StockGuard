      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-500 via-orange-600 to-amber-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
          <div className="mb-8">
            ...
            <p className="text-xl text-orange-100 mt-2 font-medium">{t.appName !== 'StockGuard' ? t.appName : 'Inventory Guard'}</p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-xs text-gray-400 mt-0.5">{t.appName !== 'StockGuard' ? t.appName : 'Inventory Guard'}</p>
          </div>
