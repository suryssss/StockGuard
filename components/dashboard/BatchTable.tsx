...
import { MinusCircle, Loader2, Search, AlertTriangle, Package, ChevronDown, ChevronUp } from 'lucide-react'
        ...
        <div className="bg-white rounded-3xl border-2 border-amber-200 shadow-xl shadow-amber-100/40 overflow-hidden">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-black text-white text-base tracking-tight">Critical Batches</h3>
                  ...
                  <td colSpan={7} className="px-5 py-16 text-center">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-xs">Try adjusting your search</p>
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td colSpan={7} className="px-5 py-12 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-gray-500 font-medium">All batches are expiring soon</p>
                      <p className="text-gray-400 text-xs">Check the critical batches section above</p>
                    </div>
                  </td>
                </tr>
              )}
